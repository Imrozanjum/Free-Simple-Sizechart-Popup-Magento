...
*
*
*/class Mambaweb_SimpleSizechartpopup_Model_Identity extends Varien_Object
{
    static public function getAllOptions()
    {
        return array(
            1    => Mage::helper('simplesizechartpopup')->__('Global Configuration'),
            2    => Mage::helper('simplesizechartpopup')->__('Set at below here')
        );
    }
}