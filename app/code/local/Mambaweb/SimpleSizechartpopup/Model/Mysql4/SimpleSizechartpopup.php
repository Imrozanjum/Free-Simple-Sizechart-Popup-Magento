...
*
*/
class Mambaweb_SimpleSizechartpopup_Model_Mysql4_SimpleSizechartpopup extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct()
    {    
        // Note that the simplesizechartpopup_id refers to the key field in your database table.
        $this->_init('simplesizechartpopup/simplesizechartpopup', 'simplesizechartpopup_id');
    }
}