...
*
*/
class Mambaweb_SimpleSizechartpopup_Model_Mysql4_SimpleSizechartpopup_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    public function _construct()
    {
        parent::_construct();
        $this->_init('simplesizechartpopup/simplesizechartpopup');
    }
}